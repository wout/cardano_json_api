database_name = "cardano_json_api_#{LuckyEnv.environment}"
...
CardanoDatabase.configure do |settings|
  settings.credentials = Avram::Credentials.parse(ENV["CARDANO_DATABASE_URL"])
end
